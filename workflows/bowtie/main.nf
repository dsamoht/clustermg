...
workflow BOWTIE {
    ...
    sample_input
        ...
        .map { meta, files -> return [ meta, [files[0], files[1], files[2]] ] }
        .set { ch_to_bowtie }
    ...
    ch_aligned_samples = SAMTOOLS(to_samtools_ch)
        .map { meta, files, sorted_bam ->
            return [ meta, [files[0], files[1], files[2], sorted_bam ] ]
        }
    ...
    sample_input
        ...
        .map { meta, files -> return [ meta, [files[0], files[1], files[2], files[4]] ] }
        .set { ch_with_bam }
